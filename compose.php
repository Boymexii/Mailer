...
if (isset($_POST['send'])) {
    ...
    if (file_exists("User_Data/$to")) {
        ...
        fwrite($fo1, $msg);
        $err = "<font color='green'>Message sent!</font>";
    } else {
        // for recever
        //for recever
        ...
        $fo1 = fopen("User_Data/$user/sent/$subj1", "w");
        fwrite($fo1, $msg);
        $err = "<font color='green'>Message sending failed :(</font>";
    }
}
if (isset($_POST['save'])) {
    $sub = $_POST['sub'];
...
<table border="" width="100%" height="100%" align="center" bgcolor="#999999">
    <form method="post">
        ...
        <tr>
            <td colspan="2" align="center"><input class="btn btn-default" type="submit" value="Send" name="send"/>
