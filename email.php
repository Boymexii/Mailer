...
if ($_SESSION['user'] == "") {
    ...
    <html>
    <head>
        <title>Welcome to your e-mail ...</title>
    ...
    <form method="post">
        <table width="100%" height="100%" border="0" bordercolor="#CCCCCC" cellpadding="0" cellspacing="0" align="left">
            <tr style="background-color:#660066">
                <td height="30" colspan="2">
                    ...
                    <span><a href="email.php?option=set" style="color:#FF0000">Setting</a></span>
	    ...
	    <span style="margin-left:45%"><a href="email.php?option=edit">Edit_Profile</a>
	<a href="email.php?option=pass">Change_Password</a>
	<a href="email.php?option=theme">Change_Themes</a>
	</span>
            ...
            <tr>
                <td width="198" align="center" valign="top" style="background-color:#66FFCC;padding:10px">
                    <a href="email.php?option=compose">COMPOSE</a><br/><br/>
                    <a href="email.php?option=inbox">INBOX</a><br/><br/>
                    <a href="email.php?option=sent">SENT</a><br/><br/>
                    <a href="email.php?option=draft">DRAFT</a><br/><br/>
                    <a href="email.php?option=spam">SPAM</a> <br/><br/>
                    <a href="email.php?option=trash">TRASH</a><br/>
                </td>
            ...
            <tr>
                <td colspan="2" align="center">Developed By Boymexii</td>
            </tr>
    </form>
    </table>
    </body>
